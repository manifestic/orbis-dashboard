...
function ClientCommandCenter() {
  ...
  return (
    <main className="ybq-dashboard min-h-screen overflow-x-hidden bg-[#f5f8fb] text-[#102336]">
      <style>{`
        .ybq-dashboard { --ybq-blue:#1377b8; --ybq-teal:#0e9a85; --ybq-ink:#102336; --ybq-muted:#607286; --ybq-line:#dbe5ed; --ybq-amber:#8a5200; --ybq-green:#087b68; }
      ...
      <div className="relative z-10 flex min-h-screen">
        <aside className="hidden w-[238px] shrink-0 border-r border-white/[0.07] bg-[#0b0f1a]/90 px-4 py-5 lg:flex lg:flex-col">
          ...
          <nav className="space-y-1 text-sm">
            ...
            <SideNavItem icon={Globe2} label="Websites" href="https://yourbesthealthquote.vercel.app/" />
